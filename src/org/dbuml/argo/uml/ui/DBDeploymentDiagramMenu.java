...
public class DBDeploymentDiagramMenu extends ActionAddDiagram {
    
    /**
     * 
     * @param sDiagName 
     */
    public DBDeploymentDiagramMenu(String sDiagName) { super(sDiagName); }
    
    public DBDeploymentDiagramMenu() { super("DBDeploymentDiagramMenu"); }
    ...
    public UMLDiagram createDiagram(Object ns) {
        return new DBDeploymentDiagram(ns);
    }
